...
<office:document-content xmlns:meta="urn:oasis:names:tc:opendocument:xmlns:meta:1.0"
    ...
    <office:font-face-decls>
        ...
        <style:font-face style:name="Arial1" svg:font-family="Arial" style:font-adornments="Regular" style:font-family-generic="roman" style:font-pitch="variable"/>
    ...
    <office:automatic-styles>
        ...
        <style:style style:name="gr3" style:family="graphic" style:parent-style-name="SPM_3a__20_Description_20_of_20_experiment">
        ...
        <style:style style:name="gr5" style:family="graphic" style:parent-style-name="SPM_3a__20_Filename">
            <style:graphic-properties fo:min-height="0.395cm"/>
            <style:paragraph-properties style:writing-mode="lr-tb"/>
        </style:style>
        <style:style style:name="gr6" style:family="graphic" style:parent-style-name="SPM_3a__20_Channel">
            <style:graphic-properties fo:min-height="0.395cm"/>
            <style:paragraph-properties style:writing-mode="lr-tb"/>
        </style:style>
        <style:style style:name="gr7" style:family="graphic" style:parent-style-name="SPM_3a__20_Scalebar_20_caption">
        ...
        <style:style style:name="T2" style:family="text">
            <style:text-properties fo:color="#808080" loext:opacity="100%" fo:font-size="12pt" fo:font-weight="bold" style:font-weight-asian="bold" style:font-weight-complex="bold"/>
        </style:style>
    ...
    <office:body>
        <office:presentation>
            <draw:page draw:name="Slide Title" draw:style-name="dp1" draw:master-page-name="Default" presentation:presentation-page-layout-name="AL1T19">
                <draw:frame presentation:style-name="pr1" draw:text-style-name="P1" draw:layer="layout" svg:width="25.199cm" svg:height="3.505cm" svg:x="1.4cm" svg:y="0.837cm" presentation:class="title">
                    <draw:text-box>
                        <text:p>{{ title }}</text:p>
                    </draw:text-box>
                </draw:frame>
            ...
            {{#pages}}
            <draw:page draw:name="Slide {{ n }}" draw:style-name="dp1" draw:master-page-name="Default">
                <draw:frame draw:style-name="gr3" draw:text-style-name="P1" draw:layer="layout" svg:width="27.998cm" svg:height="2.759cm" svg:x="0.002cm" svg:y="0cm">
                    <draw:text-box>
                        {{#comments}}
                        <text:p>{{.}}</text:p>
                        {{/comments}}
                ...
                {{#images}}
                <draw:g>
                    <draw:frame draw:style-name="gr4" draw:text-style-name="P5" draw:layer="layout" svg:width="{{ width }}cm" svg:height="{{ height }}cm" svg:x="{{ image_x }}cm" svg:y="{{ image_y }}cm">
                        <draw:image xlink:href="{{ filename_odp }}" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad" draw:mime-type="image/png">
                            <text:p/>
                        </draw:image>
                    </draw:frame>
                    <draw:g>
                        ...
                        <draw:frame draw:style-name="gr6" draw:text-style-name="P1" draw:layer="layout" svg:width="{{ halfwidth }}cm" svg:height="0.395cm" svg:x="{{ channel_x }}cm" svg:y="{{ channel_y }}cm">
                            <draw:text-box>
                                <text:p>{{ channel_name }}{{ channelbias_sep }} {{ bias }}{{#feedback}}{{#bias}},{{/bias}}{{/feedback}} {{ feedback }}</text:p>
                            </draw:text-box>
                        </draw:frame>
                    ...
                    <draw:g>
                        ...
                        <draw:frame draw:style-name="gr7" draw:text-style-name="P1" draw:layer="layout" svg:width="{{ halfwidth }}cm" svg:height="0.556cm" svg:x="{{ scalebar_label_x }}cm" svg:y="{{ scalebar_label_y }}cm">
                            <draw:text-box>
                                <text:p>{{ scalebar_width_nm }} {{ scalebar_unit }}</text:p>
                            </draw:text-box>
                        </draw:frame>
                    </draw:g>
                    {{/scalebar_show}}
                ...
                <presentation:notes draw:style-name="dp2">
                    ...
                    <draw:frame presentation:style-name="pr3" draw:text-style-name="P4" draw:layer="layout" svg:width="17.271cm" svg:height="12.572cm" svg:x="2.159cm" svg:y="13.271cm" presentation:class="notes" presentation:placeholder="true">
                        <draw:text-box/>
                    </draw:frame>
                </presentation:notes>
            </draw:page>
